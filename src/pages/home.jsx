...
const Home = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className="xl:max-w-[2560px] bg-[#F7F7F7] mx-auto">
        <FinanceAd />
      </div>
            ...
            >
              ...
              <div className="pb-4 mb-4 relative flex justify-between items-center mt-6">
                ...
                <img
                  src="/piccc.PNG"
                  alt="Dealer"
                  className="sm:w-[100px] sm:h-[100px] w-[74px] h-[86px] absolute top-0 -right-5 sm:right-0 sm:rounded-full rounded-[12px] object-cover bg-center bg-no-repeat"
                />
