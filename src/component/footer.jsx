...
const Footer = () => {
  return (
    <footer className="bg-white border-t border-gray-200">
      {/* Top Banner */}
      <div className="bg-[#0A2540] text-white py-10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 text-center text-[#878B96]">
        ...
        <div className="flex justify-center gap-3 mt-10">
          <img
            src="/appstore.png"
            alt="App Store"
            className="h-10 brightness-0 invert-[50%] sepia-[20%] saturate-[600%] hue-rotate-[80deg] "
          />
          <img
            src="/googleplay.png"
            alt="Google Play"
        ...
        {/* Copyright */}
        <div className="mt-10 mb-6 text-[#002D4A] font-poppins font-normal text-[19px] leading-[33px] tracking-[-0.03em]">
